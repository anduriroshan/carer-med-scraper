...
async def crawl_article_jaad(specialization):
...
async def crawl_article_wiley(specialization):
    journal_name = 'Wiley Journal'
    connection = connection_config()
    table_name = specialization
    ...
    try:
        ...
        for link_tuple in links:
            ...
            try:
                ...
                if abstract_div:
                    sections = abstract_div.find_all('section')
...
async def crawl_article_jid(specialization):
    journal_name = 'Journal of Investigative Dermatology'
    connection = connection_config()
    table_name = specialization
...
async def crawl_article_derma_clinics(specialization):
    journal_name = 'Dermatologic Clinics'
    connection = connection_config()
    table_name = specialization
...
async def main():
    specialization='dermatology'
    await crawl_article_derma_clinics(specialization)
    await crawl_article_jaad(specialization)
    await crawl_article_jama(specialization)
    await crawl_article_jid(specialization)
    await crawl_article_wiley(specialization)
