...
async def crawl_article_jasn(specialization):
...
async def crawl_article_kidney(specialization):
...
async def crawl_article_cjasn(specialization):
...
async def crawl_article_ndt(specialization):
...
async def crawl_article_ajkd(specialization):
