...
async def crawl_article_ajog(specialization):
    journal_name = "American Journal of Obstetrics & Gynecology"
...
async def crawl_article_bjog(specialization):
    journal_name = 'BJOG: An International Journal of Obstetrics & Gynaecology'
    connection = connection_config()
    table_name = specialization
...
async def crawl_article_obs_gyn(specialization):
    journal_name ='Obstetrics & Gynecology'
    connection = connection_config()
    table_name = specialization
...
async def crawl_article_fertstert(specialization):
    journal_name = "Fertility and Sterility"
    connection = connection_config()
    table_name = specialization
    ...
    try:
        ...
        for link_tuple in links:
            ...
            try:
                ...
                abstract_html = [tag.get("content") for tag in soup.find_all("meta", attrs={"name": "citation_abstract"})]
                if abstract_html != []:
