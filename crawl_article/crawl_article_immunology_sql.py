...
async def crawl_article_natural(specialization):
    journal_name = 'Nature Reviews Immunology'
...
async def crawl_article_immunity(specialization):
    ...
    try:
        ...
        for link_tuple in links:
            ...
            try:
                ...
                article_abstract = meta_tags.get("citation_abstract", "N/A")
...
async def crawl_article_trends(specialization):
    journal_name = 'Trends in Immunology'
    connection = connection_config()
    table_name = specialization
...
async def crawl_article_jaci(specialization):
    journal_name = 'Journal of Allergy and Clinical Immunology'
    connection = connection_config()
    table_name = specialization
...
async def main():
    specialization='immunology'
    await crawl_article_immunity(specialization)
    await crawl_article_jaci(specialization)
    await crawl_article_natural(specialization)
    await crawl_article_trends(specialization)
