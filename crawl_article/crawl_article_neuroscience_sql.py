...
async def crawl_article_nature(specialization):
    journal_name = 'Nature Reviews Neuroscience'
...
async def crawl_article_neuron(specialization):
    journal_name = 'Neuron'
    connection = connection_config()
    table_name = specialization
...
async def crawl_article_brain(specialization):
    journal_name = 'Brain'
    connection = connection_config()
    table_name = specialization
    try:
...
async def crawl_article_trends(specialization):
    journal_name = 'Trends in Neuroscience'
    connection = connection_config()
    table_name = specialization
...
async def crawl_article_jneuro(specialization):
...
async def main():
    ...
    await crawl_article_brain(specialization)
    await crawl_article_jneuro(specialization)
    await crawl_article_nature(specialization)
    await crawl_article_neuron(specialization)
