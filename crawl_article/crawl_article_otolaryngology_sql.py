...
async def crawl_article_jama_ent(specialization):
    journal_name = "JAMA Otolaryngology–Head & Neck Surgery"
...
async def crawl_article_laryngoscope(specialization):
    journal_name = 'The Laryngoscope'
    connection = connection_config()
    table_name = specialization
...
async def crawl_article_sage(specialization):
...
async def crawl_article_ear_hearings(specialization):
    journal_name ='Ear and Hearing'
    connection = connection_config()
    table_name = specialization
