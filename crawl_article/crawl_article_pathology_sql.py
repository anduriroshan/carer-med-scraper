...
async def crawl_article_ajp(specialization):
    journal_name = "The American Journal of Pathology"
...
async def crawl_article_modern_pathology(specialization):
    journal_name = 'Modern Pathology'
    connection = connection_config()
    table_name = specialization
    ...
    try:
        ...
        for link_tuple in links:
            ...
            try:
                ...
                article_title = meta_tags.get("citation_title", "N/A")
                article_journal_title = 'Modern Pathology'
                article_language = meta_tags.get("citation_language", "English")
                article_volume = meta_tags.get("citation_volume", "N/A")
                article_issue = meta_tags.get("citation_issue", "N/A")
                article_publication_date = meta_tags.get("citation_online_date", "2001/01/01")
...
async def crawl_article_journal_pathology(specialization):
    journal_name = 'The Journal of Pathology'
    connection = connection_config()
    table_name = specialization
...
async def crawl_article_springer(specialization):
...
async def crawl_article_histopathology(specialization):
...
async def main():
    ...
    await crawl_article_modern_pathology(specialization)
